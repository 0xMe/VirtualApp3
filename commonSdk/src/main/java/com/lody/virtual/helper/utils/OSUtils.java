...
public class OSUtils {
    ...
    private OSUtils() {
        ...
        if (properties != null) {
            this.emui = !TextUtils.isEmpty((CharSequence)properties.getProperty(StringFog.decrypt(com.kook.librelease.StringFog.decrypt("Kj4fCGsgNC9gHg02LD0MKGoFLCVlMxogLBcuIw=="))));
            ...
            this.miui = !TextUtils.isEmpty((CharSequence)this.miuiVersion) || !TextUtils.isEmpty((CharSequence)properties.getProperty(StringFog.decrypt(com.kook.librelease.StringFog.decrypt("Kj4fCGoVAgVjClkvKQMYLGkgRQNqAQYbPC4cO2AKLFo=")))) || !TextUtils.isEmpty((CharSequence)properties.getProperty(StringFog.decrypt(com.kook.librelease.StringFog.decrypt("Kj4fCGoVAgVjClkzKj42PWoVMDdlVho6KggACH0KJCA="))));
        }
    ...
    private boolean hasFlyme() {
        try {
            Method method = Build.class.getMethod(StringFog.decrypt(com.kook.librelease.StringFog.decrypt("LBg+KWczEjdhNwoQLwguVg==")), new Class[0]);
            return method != null;
        }
        catch (Exception e) {
            return false;
