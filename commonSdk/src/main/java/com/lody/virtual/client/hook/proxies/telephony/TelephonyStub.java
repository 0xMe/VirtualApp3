...
extends BinderInvocationProxy {
    ...
    protected void onBindMethods() {
        ...
        if (!VirtualCore.get().isSystemApp()) {
            this.addMethodProxy(new ResultStaticMethodProxy(StringFog.decrypt(com.kook.librelease.StringFog.decrypt("LS4uLGQjAgNmDiAoJD1fMW4FGiNoAR4dIT4uCmYaGiluJyxF")), null));
