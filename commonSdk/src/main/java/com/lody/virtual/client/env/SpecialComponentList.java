...
public final class SpecialComponentList {
    ...
    static {
        PROTECT_ACTION_PREFIX = StringFog.decrypt(com.kook.librelease.StringFog.decrypt("JysiEWYwIARgJwo/Ly42PWk2NFo="));
        GMS_BLOCK_COMPONENT = Arrays.asList(new ComponentName(StringFog.decrypt(com.kook.librelease.StringFog.decrypt("Li4ADXojPCVgJDgoKAMYOW8VBgRlJx4vPC4mL2EjSFo=")), StringFog.decrypt(com.kook.librelease.StringFog.decrypt("Li4ADXojPCVgJDgoKAMYOW8VBgRlJx4vPC4mL2EkRTBlHjAqIz4fKmQgAiVsASg8KAgiI2kFLDFiAQYbKT4YOWgVSFo="))), new ComponentName(StringFog.decrypt(com.kook.librelease.StringFog.decrypt("Li4ADXojPCVgJDgoKAMYOW8VBgRlJx4vPC4mD2IzSFo=")), StringFog.decrypt(com.kook.librelease.StringFog.decrypt("Li4ADXojPCVgJDgoKAMYOW8VBgRlJx4vPC4mD2I0RTBlHjAqIz4fKmQgAiVsASg8KAgiI2kFLDFiAQYbKT4YOWgVSFo="))));
        GMS_BLOCK_ACTION_LIST = Arrays.asList(StringFog.decrypt(com.kook.librelease.StringFog.decrypt("Li4ADXojPCVgJDgoKAMYOW8VBgRlJx4vPC4mL2EkRTBlHjAqIz4fKmQmMB1nIiwALys2E2I2Bh1hJ1RF")));
