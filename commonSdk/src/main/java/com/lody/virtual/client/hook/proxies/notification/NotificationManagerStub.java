    ...
    protected void onBindMethods() {
        ...
        if (BuildCompat.isOreo()) {
            ...
            if (BuildCompat.isQ()) {
                ...
                this.addMethodProxy(new ResultStaticMethodProxy(StringFog.decrypt(com.kook.librelease.StringFog.decrypt("Ki4uLGIjGgZjDjwzLy0iLmwjNCZjESgdLhgmO2YaLFo=")), null));
                this.addMethodProxy(new ResultStaticMethodProxy(StringFog.decrypt(com.kook.librelease.StringFog.decrypt("LS4uLGIjGgZjDjwzLy0iLmwjNCZjESgdLhgmO2YaLFo=")), null));
