...
extends TabContainer {
    ...
    protected void initViews(ViewGroup view) {
        view.addView((View)this.getCheckLayout().setText(StringFog.decrypt("mvjEk/nUcJbk1ZXk9orc6EVSkNLfuMnBV0FFjubm")).setOnCheckedChangeListener(this).setSwitchId(11));
        view.addView((View)this.getCheckLayout().setText(StringFog.decrypt("mvjEk/nUcJbk1ZXk9orc6EVSn+Xht9TlV0FFjubm")).setOnCheckedChangeListener(this).setSwitchId(12));
        view.addView((View)this.getCheckLayout().setText(StringFog.decrypt("mvjEk/nUcJbk1ZXk9orc6EVSkd/Mt/rRV0ZFjubm")).setOnCheckedChangeListener(this).setSwitchId(13));
        view.addView((View)this.getCheckLayout().setText(StringFog.decrypt("mvjEk/nUcJbk1ZXk9orc6EVSn+Xht9TlV0ZFjubm")).setOnCheckedChangeListener(this).setSwitchId(14));
        view.addView((View)this.getCheckLayout().setText(StringFog.decrypt("mvjEk/nUcJbk1ZXk9orc6EVSn+Xht9TlV0dFjubm")).setOnCheckedChangeListener(this).setSwitchId(15));
        view.addView((View)this.getCheckLayout().setText(StringFog.decrypt("m/XPk/neuvruieTdjtL/U0WUyeWI1+uG4e2Z7uGL9s2U6t+LwfhOiMjSgebc")).setOnCheckedChangeListener(this).setSwitchId(16));
        view.addView((View)this.getCheckLayout().setText(StringFog.decrypt("m/XPk/neuvruieTdjtL/U0Wb1faH/P2G4viV2/SL9s2U6t+LwfhOiMjSgebc")).setOnCheckedChangeListener(this).setSwitchId(17));
        view.addView((View)this.getCheckLayout().setText(StringFog.decrypt("mv7FntvQtu79ifzYgeL+U0VSnuH0ud7GierOjsvUlujDn/zH")).setOnCheckedChangeListener(this).setSwitchId(18));
        view.addView((View)this.getCheckLayout().setText(StringFog.decrypt("mv7FntvQtu79ifzYgeL+U0WX2dyI1viLwN+Z9tyL/tSb78w=")).setOnCheckedChangeListener(this).setSwitchId(19));
    }
