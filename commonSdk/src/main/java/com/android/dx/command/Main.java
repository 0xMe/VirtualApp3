    ...
    public static void main(String[] args) {
        ...
        try {
            for (int i = 0; i < args.length; ++i) {
                ...
                gotCmd = true;
                if (arg.equals("--dex")) {
                    com.android.dx.command.dexer.Main.main(Main.without(args, i));
                    break;
                }
                if (arg.equals("--dump")) {
                    com.android.dx.command.dump.Main.main(Main.without(args, i));
                    break;
                }
                if (arg.equals("--annotool")) {
                    com.android.dx.command.annotool.Main.main(Main.without(args, i));
                    break;
                }
                if (arg.equals("--find-usages")) {
                    com.android.dx.command.findusages.Main.main(Main.without(args, i));
                    break;
                }
